...
urlpatterns = [
    ...
    path('friendship/<int:pk>', FriendshipViewsetList.as_view({'get': 'get'}), name="friendship_get"),
    path('friendship/friends/<int:pk>', FriendshipViewsetList.as_view({'get': 'list'}), name="friendship_list"),
